...
<div>
  ...
  className='w-full mt-1 px-4 py-2 border border-gray-300 rounded-md resize-none focus:ring-2-[black] ' onChange={(e)=>setDescription(e.target.value)} value={description} />
</div>
