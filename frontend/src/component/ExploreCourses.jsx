...
function ExploreCourses() {
 ...
 '>
      {/* left/top div */}
    <div className='w-[100%] lg:w-[350px] lg:h-[100%] h-[400px] flex flex-col item-start justify-center gap-1 md:px-[40px] px-[20px] ' >
...
<FaHackerrank className='w-[60px] h-[60px] text-[#6d6c6c] '/>
   ...
   <div className='w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center '>
    <div className='w-[100px] h-[90px] bg-[#d9fbe0] rounded-lg flex items-center justify-center '>
<PiOpenAiLogoFill className='w-[60px] h-[60px] text-[#6d6c6c] '/>
    </div>
    AI/ML
  </div>
...
< BsClipboardData className='w-[60px] h-[60px] text-[#6d6c6c] '/>
   ...
   <div className='w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center '>
    <div className='w-[100px] h-[90px] bg-[#d9fbe0] rounded-lg flex items-center justify-center '>
<AiOutlineTool className='w-[60px] h-[60px] text-[#6d6c6c] '/>
    </div>
    AI Tools
  </div>
